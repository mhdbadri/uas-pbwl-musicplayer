                    ...
                    <tbody>
                        @foreach($played as $item)
                            ...
                            <td class="text-center">
                                <a href="{{ url("/played/{$item->play_id}/edit") }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <form action="{{ url ("/played/{$item->play_id}") }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin Hapus Data?')">
                                    @method('delete')
                                    @csrf
